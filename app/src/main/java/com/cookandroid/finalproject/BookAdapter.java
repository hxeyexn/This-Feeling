...
public class BookAdapter extends BaseAdapter {
    ...
    public BookAdapter(Context context, String[] arrBookWord, int[] arrBookImage) {

        this.context = context;
        this.arrBookWord = arrBookWord;
        this.arrBookImage = arrBookImage;
    }

    //자식 뷰(어댑터 뷰의 자식 뷰)들의 개수를 리턴하는 메소드
    @Override
    public int getCount() {
        return arrBookWord.length;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        TextView bookWord = view.findViewById(R.id.bookText);

        bookImage.setImageResource(arrBookImage[position]);
        bookWord.setText(arrBookWord[position]);
